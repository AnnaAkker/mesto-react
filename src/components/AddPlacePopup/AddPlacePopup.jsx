    ...
    return(
        ...
        >
          <input
              id="title-input"
              type="text"
              className={`popup__input popup__input_type_title ${isValidInput.title === undefined || isValidInput.title ? '' : 'popup__input_invalid'}`}
              name="title"
          ...
          <input
            id="link-input"
            type="url"
            className={`popup__input popup__input_type_link ${isValidInput.link === undefined || isValidInput.link ? '' : 'popup__input_invalid'}`}
            name="link"
